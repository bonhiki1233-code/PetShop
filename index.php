    ...
    <section class="hero">
        <div class="hero-card">
            ...
            <p>
                ...
                Giao dien duoc sap xep gon gang hon de nguoi dung xem san pham va di chuyen nhanh giua cac trang.
            </p>
            ...
            <div class="stats">
                ...
                <div class="panel">
                    <strong>24/7</strong>
                    <span>Ho tro tham khao mua hang</span>
                </div>
                <div class="panel">
                    <strong>5+</strong>
                    <span>Nhom anh that da duoc gan</span>
                </div>
            </div>
        </div>

        <aside class="hero-card hero-aside">
            <h2>Ly do giao dien nay de dung hon</h2>
            <ul>
                <li>Trang chu tap trung gioi thieu va dan huong vao danh muc san pham.</li>
                <li>The san pham hien thi ro anh, gia, loai va noi dung tom tat.</li>
                <li>Cac trang dang nhap va dang ky da dong bo cung mot bo style.</li>
            </ul>
        </aside>
    </section>
    ...
    <section>
        <div class="section-heading">
            <div>
                ...
                <p>Mot vai san pham duoc lay tu co so du lieu de nguoi dung xem nhanh ngay tai trang chu.</p>
            </div>
